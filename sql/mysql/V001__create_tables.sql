...
CREATE INDEX idx_pay_channels_app ON pay_channels(app_id);
...
CREATE INDEX idx_pay_orders_app ON pay_orders(app_id);
CREATE UNIQUE INDEX idx_pay_orders_merchant ON pay_orders(merchant_order_id);
...
CREATE INDEX idx_pay_refunds_order ON pay_refunds(order_id);
...
CREATE UNIQUE INDEX idx_pay_wallets_user ON pay_wallets(user_id);
...
CREATE INDEX idx_pay_wallet_recharges_wallet ON pay_wallet_recharges(wallet_id);
...
CREATE INDEX idx_pay_wallet_transactions_wallet ON pay_wallet_transactions(wallet_id);
